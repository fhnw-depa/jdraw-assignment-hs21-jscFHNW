...
public class DrawModelEvent {
	...
	public enum Type {
		...
		/**
		 * Indicates that the position or the size of a figure was changed in the draw
		 * model.
		 */
		FIGURE_CHANGED,

		/**
		 * This event indicates that the whole drawing was cleared, i.e.\ all figures
		 * were removed at once.
		 */
		DRAWING_CLEARED,

		/**
		 * This event indicates that more than one figure has changed, e.g.\ that the
		 * order of the figures has changed. The view has to redraw the whole scene.
		 * However, no figure was added or removed.
		 */
		DRAWING_CHANGED
	}
	...
	/**
	 * The affected figure upon which the event is reporting. If the event type is
	 * either DRAWING_CLEARED or DRAWING_CHANGED, then this field may be
	 * <code>null</code>.
	 */
