 ...
 * iterated through using methods undo and redo.
 *
...
public interface DrawCommandHandler {
	...
	/**
	 * Adds a new command to the command list at the current position. The added
	 * command is not executed by this method. Commands which were stored behind the
	...
	/**
	 * Opens a script. Commands added with method addCommand after a script has been
	 * opened are collected until endScript is called. These command are then
	 * combined to a macro command.
	 * 
	 * @see #endScript
	 */
	void beginScript();
	...
	/**
	 * Closes a script. All commands added since the last open beginScript call are
	 * combined to a macro command.
	 * 
	 * @see #beginScript
	 */
