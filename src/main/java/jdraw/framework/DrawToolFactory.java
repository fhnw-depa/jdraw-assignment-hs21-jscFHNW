...
public interface DrawToolFactory {
	...
	/**
	 * Returns the name of the created tool. If this value is not null, then it will
	 * overwrite the name of the created tool
	 * 
	...
	/**
	 * Sets the name to be used for the created draw tool. This name overwrites the
	 * name of the draw tool implementation.
	 * 
	...
	/**
	 * Returns the path of the draw tool icon. If this value is not null, then it
	 * will overwrite the path of the created tool.
	 * 
