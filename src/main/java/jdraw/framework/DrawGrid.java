...
public interface DrawGrid {
	 ...
	 * used to setup data used during this mouse interaction. If during an
	 * interaction another muse button is pressed, this method is invoked again.
	 */
	void mouseDown();

	/**
	 * Indicates that a mouse interaction has been finished. This method might be
	 * used to clean-up data created in method mouseDown. If an additional mouse
	 * button pressed during an interaction is released, then this method is invoked
	 * as well.
	 */
	void mouseUp();
