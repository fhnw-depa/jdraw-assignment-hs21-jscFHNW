...
public class RemoveFigureCommand implements DrawCommand {
	 ...
	 *                                  This means, that the RemoveFigureCommand
	 *                                  instance must be created BEFORE the figure
	...
	/**
	 * Add a removed figure again the the model. <b>Note:</b> This implementation
	 * does not test if the figure is already contained in the model. It assumes
	 * that the model implements set semantics concerning addition of figures, i.e.
	 * the same figure can be added repeatedly without affecting the figure list of
	 * the model.
	 */
	@Override
	public void undo() {
