...
/**
 * The default tool is used for figure selection and general manipulation of one
 * or more figures.
 * 
...
public class StdSelectionTool implements DrawTool {
	...
	/**
	 * indicates whether the tool is in selection mode, ie. whether a selection is
	 * in progress.
	 */
	...
	/**
	 * Makes Rectangles with negative width and/or height non-empty. According to
	 * the API specification, a Rectangle is empty if it has a width or a height
	 * that is smaller or equals 0. This method adjusts the Dimension of a Rectangle
	 * such that it becomes non-empty
	 * 
	 * @param r a potentially empty Rectangle
	 * @return a non-empty Rectangle with the same Dimension as the input parameter.
