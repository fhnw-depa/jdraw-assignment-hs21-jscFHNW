...
//				}
	...
	/**
	 * Internal method, which constraints the location of point p according to the
	 * rules of the underlying grid. The mode parameter indicates whether the method
	 * was called from within mousePressed, mouseDragged or mouseReleased. Depending
	 * on the mode, this method also calls the mouseDown and mouseUp methods on the
	 * grid.
	 * 
	 * @param p    the point to constrain
	 * @param mode indicates from which method this method is called (mousePressed,
	 *             mouseDragged or mouseReleased). Depending on the source, this
	 *             method in addition calls mouseDown and mouseUp on the grid
	 *             instance (if it is set).
	 * @return a point that is the result of constraining p, ie. the new location of
	 *         p according to the grid.
	 */
